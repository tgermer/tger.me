...
date: 2026-07-21
description: "Aus vielen Erfahrungen, Projekten und Rückmeldungen entstand im Workshop ein klareres berufliches Selbstbild: TCOM als persönliches Denk- und Arbeitsmodell."
...
```mermaid
flowchart TB
    A["Neugier"] --> B["Beobachten"]
    B --> C["Lernen und Wissen sammeln"]
    C --> D["Wiederkehrende Muster erkennen"]
    D --> E["Mentales Modell entwickeln"]
    E --> F["Zusammenhänge verstehen"]
    F --> G["Reibung und Potenziale erkennen"]
    G --> H["Lösungsraum erweitern"]
    H --> I["Passende Lösung gestalten"]
    I --> J["Menschen befähigen"]
    J --> K["Wirkung beobachten"]
    K --> B

    D -. "kein belastbares Muster" .-> B
    F -. "Verständnis noch unvollständig" .-> B
    I -. "neue Erkenntnisse" .-> E
```
