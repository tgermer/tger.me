...
export const experience: ExperienceItem[] = [
    {
        ...
        description: {
            list: ["Bewusste berufliche Übergangsphase zur fachlichen Vertiefung und strategischen Neupositionierung.", "Schwerpunkt auf Digitalisierung, Automatisierung und Systemsteuerung in Querschnitts- und Stabsfunktionen.", "Übertragung technischer Automatisierungs- und Steuerungslogiken auf organisatorische Kontexte."],
        },
...
export const projects: ProjectItem[] = [
    {
        ...
        description: {
            list: ["Web-App zum Erstellen professioneller Beschriftungen für Schalter und Fernbedienungen von Smart-Home-Systemen.", "Eigenständige Konzeption und Umsetzung eines produktiven Web-Tools zur Lösung eines konkreten Anwenderproblems.", "Fokus auf UX, Systemlogik, Automatisierung und funktionierende End-to-End-Lösung."],
        },
        date: "2026-01-01",
    },
];
