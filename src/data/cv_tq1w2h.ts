...
export const basics: Basics = {
    name: "Tristan Germer",
    label: "Product Manager | Digitalization & Automation | User-Centric Product Delivery",
...
export const work: Work[] = [
    {
        name: "Career Transition – Product Management & Digital Product Development",
        location: "",
        typeOfEmployment: "Career Reorientation",
        highlights: ["Deliberate professional transition focused on deepening product management expertise and building hands-on experience with modern web and AI-driven product development.", "End-to-end product ownership of ClearControl.de: conceived, designed, and shipped a live web application solving a real user problem in smart home automation — from user research and UX design to technical implementation.", "Independent study of browser platform capabilities, AI/ML-driven features (autofill, prediction systems), and product frameworks including OKR-based roadmapping and data-driven decision-making."],
    ...
    },
    {
        ...
        highlights: ["Drove improvements to organization-wide controlling systems, including KPI development and management reporting frameworks.", "Redesigned the evaluation system with automation, measurably increasing feedback process efficiency and reducing manual effort.", "Defined requirements, developed, and delivered training programs for digital tools (Confluence, MS Office, evasys), improving adoption across staff.", "Translated complex organizational needs into actionable product requirements across multiple cross-functional stakeholder groups."],
    ...
    },
    {
        ...
        highlights: ["Defined product vision and roadmap for a DMS (d.velop d3) to digitize application and administrative processes; owned the full product lifecycle from business case through engineering collaboration, piloting, and organization-wide rollout.", "Drove measurable impact at scale: redesigned document-centric workflows across 14 faculties handling >200,000 documents/year, reducing processing and form submission time by ~30 % through targeted UX improvements and automation.", "Managed cross-functional alignment across engineering, legal, and 14 faculty administrations; ensured compliance through audit-proof archiving and integration of adjacent specialized systems.", "Defined KPI frameworks and built management dashboards for transparency; maximized user adoption through structured training programs and continuous feedback loops."],
...
export const skills: Skill[] = [
    { name: "Product Management", keywords: ["Product Lifecycle (Conception to Launch)", "Roadmapping", "OKRs", "User Research", "KPI Development", "Stakeholder Management", "Agile/Scrum (PSPO\u00a0I, PSM\u00a0I)"] },
    { name: "Data Analysis", keywords: ["Excel (Advanced)", "MS Power BI"] },
    { name: "Technical Literacy", keywords: ["JavaScript", "TypeScript", "Swift", "SQL"] },
