import type { ExperienceItem, EducationItem, FurtherEducationItem, SkillCategory, Reference, ProjectItem } from './cv_de';
...
export const experience: ExperienceItem[] = [
  {
    ...
    description: {
      list: [
        'Deliberate professional transition phase for deepening expertise and strategic repositioning.',
        'Focus on digitalization, automation, and system control in cross-functional and staff roles.',
        'Transfer of technical automation and control logic to organizational contexts.',
      ],
    },
  ...
  },
  {
    ...
    description: {
      list: [
        'Project management for DMS implementation',
        'Requirements analysis & process consulting',
        'Customer training & workshops',
        'System configuration & authorization concepts',
  ...
  },
  {
    ...
    description: {
      list: [
        'Advancement of central controlling.',
        'Revision of the evaluation system, including the integration of automation and increased efficiency of the feedback process.',
        'Development, didactic preparation, and delivery of training programs (e.g., Confluence, MS Office, evasys).',
      ],
    },
  ...
  },
  {
    ...
    description: {
      list: [
        'Management and successful implementation of a DMS (d.velop d3) for digitizing application and administrative processes.',
        'Design and implementation of organization-wide workflows for 14 faculties (>200,000 documents/year), reducing processing time by approx. 30%.',
        'Ensuring compliance through audit-proof archiving and integration of adjacent specialized procedures.',
        'Conception of training programs, user support, and development of KPI dashboards for management and transparency.',
      ],
    },
...
export const projects: ProjectItem[] = [
  {
    ...
    description: {
      list: [
        'Web app for creating professional labels for switches and remote controls of smart home systems.',
        'Independent conception and implementation of a productive web tool to solve a concrete user problem.',
        'Focus on UX, system logic, automation, and a functioning end-to-end solution.',
      ],
    },
    date: '2026-01-01',
  },
